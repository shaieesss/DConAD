...
class PSMSegLoader(object):
    ...
    def __getitem__(self, index):
        ...
        if self.mode == "train":
            ...
            return np.float32(self.train[index:index + self.win_size]), np.float32(self.test_labels[0:self.win_size]), np.float32(self.train[index+1:index + self.win_size])-np.float32(self.train[index:index + self.win_size-1])
        elif (self.mode == 'val'):
            return np.float32(self.val[index:index + self.win_size]), np.float32(self.test_labels[0:self.win_size]), np.float32(self.val[index+1:index + self.win_size])-np.float32(self.val[index:index + self.win_size-1])
        elif (self.mode == 'test'):
            return np.float32(self.test[index:index + self.win_size]), np.float32(self.test_labels[index:index + self.win_size]), np.float32(self.test[index+1:index + self.win_size])-np.float32(self.test[index:index + self.win_size-1])
        else:
            return np.float32(self.test[
                              index * self.win_size:index * self.win_size + self.win_size]), np.float32(
                self.test_labels[index * self.win_size:index * self.win_size + self.win_size]), np.float32(self.test[index * self.win_size+1:index * self.win_size + self.win_size])-np.float32(self.test[index * self.win_size:index * self.win_size + self.win_size-1])
    ...
    def __getitem__(self, index):
        ...
        if self.mode == "train":
            ...
            return np.float32(self.test[index:index + self.win_size]), np.float32(
                self.test_labels[index:index + self.win_size]), np.float32(self.test[index+1:index + self.win_size])-np.float32(self.test[index:index + self.win_size-1])
        else:
            return np.float32(self.test[
                              index // self.step * self.win_size:index // self.step * self.win_size + self.win_size]), np.float32(
                self.test_labels[index // self.step * self.win_size:index // self.step * self.win_size + self.win_size]), np.float32(self.test[index * self.win_size+1:index * self.win_size + self.win_size])-np.float32(self.test[index * self.win_size:index * self.win_size + self.win_size-1])
...
def get_loader_segment(index, data_path, batch_size, win_size=100, step=1, mode='train', dataset='KDD'):
    if (dataset == 'SMD'):
